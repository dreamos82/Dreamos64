...
void prepare_tests(int pipe_fd) {
    ...
    printf("=================================\n\n");
    test_init(1, &tests);
    add_test(1, "Testing vmm utils functions", test_utils, tests);
    number_of_tests++;
}

void test_utils(unsigned int id) {
    ...
    pretty_assert_stat(1, number_of_pages, ==, tests[id].stats, "Testing number of pages for 0x900", has_pipe);
    ...
    pretty_assert_stat(0x200000, align_value_to_page(0x100), ==, tests[id].stats, "Testing alignment for for 0x100", has_pipe);
    pretty_assert_stat(0x400000, align_value_to_page(0x200015), ==, tests[id].stats, "Testing number of pages for 0x200015", has_pipe);
    pretty_assert_stat(0x200000, align_down(0x3c7000, 0x200000), ==, tests[id].stats, "Testing align_down", has_pipe);
    pretty_assert_stat(0x600000, align_down(0x6c7000, 0x200000), ==, tests[id].stats, "Testing align_down", has_pipe);
}
